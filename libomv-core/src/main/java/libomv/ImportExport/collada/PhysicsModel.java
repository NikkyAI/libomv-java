...
public class PhysicsModel {
	 ...
	 * value of the rigidBody property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the rigidBody property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link RigidBody }
	 * 
	 * 
	 */
	...
	/**
	 * 
	 * The physics_model may define any number of rigid_constraint elements. Gets
	 * the value of the rigidConstraint property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the rigidConstraint property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
