...
public class BindMaterial {
	...
	/**
	 * 
	 * The bind_material element may contain any number of param elements. Gets the
	...
	public static class TechniqueCommon {
		...
		/**
		 * 
		 * The instance_material element specifies the information needed to bind a
		 * geometry to a material. This element must appear at least once. Gets the
		 * value of the instanceMaterial property.
		 * 
		 * <p>
		 * This accessor method returns a reference to the live list, not a snapshot.
		 * Therefore any modification you make to the returned list will be present
		 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
		 * for the instanceMaterial property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
