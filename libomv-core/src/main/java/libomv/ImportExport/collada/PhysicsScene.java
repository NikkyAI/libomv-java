...
@XmlType(name = "", propOrder = { "asset", "instanceForceField", "instancePhysicsModel", "techniqueCommon", "technique",
		"extra" })
...
public class PhysicsScene {
	...
	/**
	 * 
	 * There may be any number of instance_force_field elements. Gets the value of
	 * the instanceForceField property.
	 * 
	 * <p>
	...
	/**
	 * 
	 * There may be any number of instance_physics_model elements. Gets the value of
	 * the instancePhysicsModel property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the instancePhysicsModel property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
