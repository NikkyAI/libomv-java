...
@XmlType(name = "fx_samplerRECT_common", propOrder = { "source", "wrapS", "wrapT", "minfilter", "magfilter",
		"mipfilter", "borderColor", "mipmapMaxlevel", "mipmapBias", "extra" })
@XmlSeeAlso({ CgSamplerRECT.class, GlSamplerRECT.class })
