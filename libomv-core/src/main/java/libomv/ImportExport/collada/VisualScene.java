...
public class VisualScene {
	...
	/**
	 * 
	 * The visual_scene element must have at least one node element. Gets the value
	 ...
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the evaluateScene property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	...
	public static class EvaluateScene {
		...
		public static class Render {
			...
			/**
			 * 
			 * The instance_effect element specifies which effect to render in this
