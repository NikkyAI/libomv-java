...
public class Mesh {
	...
	@XmlElements({ @XmlElement(name = "lines", type = Lines.class),
	...
	/**
	 * 
	 * The mesh element must contain one or more source elements. Gets the value of
	 * the source property.
	 * 
	 * <p>
	 ...
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the linesOrLinestripsOrPolygons property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Lines }
	 * {@link Linestrips } {@link Polygons } {@link Polylist } {@link Triangles }
	 * {@link Trifans } {@link Tristrips }
	 * 
	 * 
	 */
