...
public class InstancePhysicsModel {
	 ...
	 * elements. Gets the value of the instanceForceField property.
	 *
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the instanceForceField property.
	 *
	 * <p>
	...
	public List<InstanceWithExtra> getInstanceForceField() {
		if (instanceForceField == null) {
			instanceForceField = new ArrayList<>();
		}
	 ...
	 * elements. Gets the value of the instanceRigidBody property.
	 *
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the instanceRigidBody property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	...
	public List<InstanceRigidBody> getInstanceRigidBody() {
		if (instanceRigidBody == null) {
			instanceRigidBody = new ArrayList<>();
		}
	 ...
	 * rigid_constraint elements. Gets the value of the instanceRigidConstraint
	 * property.
	 *
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the instanceRigidConstraint property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	...
	public List<InstanceRigidConstraint> getInstanceRigidConstraint() {
		if (instanceRigidConstraint == null) {
			instanceRigidConstraint = new ArrayList<>();
		}
