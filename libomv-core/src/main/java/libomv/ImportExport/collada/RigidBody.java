...
public class RigidBody {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "dynamic", "mass", "massFrame", "inertia", "instancePhysicsMaterial",
	...
	public static class TechniqueCommon {
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link RigidBody.TechniqueCommon.Dynamic }
		 * 
		 */
		 ...
		 * 
		 * @return possible object is {@link RigidBody.TechniqueCommon.MassFrame }
		 * 
		 */
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link RigidBody.TechniqueCommon.MassFrame }
		 * 
		 */
		...
		public static class MassFrame {
			...
			@XmlElements({ @XmlElement(name = "translate", type = TargetableFloat3.class),
			 ...
			 * Therefore any modification you make to the returned list will be present
			 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
			 * for the translateOrRotate property.
			 * 
			 * <p>
			 * For example, to add a new item, do as follows:
			 * 
			 ...
			 * <p>
			 * Objects of the following type(s) are allowed in the list
			 * {@link TargetableFloat3 } {@link Rotate }
			 * 
			 * 
			 */
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "hollow", "mass", "density", "instancePhysicsMaterial", "physicsMaterial",
				"instanceGeometry", "plane", "box", "sphere", "cylinder", "taperedCylinder", "capsule",
				"taperedCapsule", "translateOrRotate", "extra" })
		public static class Shape {
			 ...
			 * 
			 * @return possible object is {@link RigidBody.TechniqueCommon.Shape.Hollow }
			 * 
			 */
			 ...
			 * 
			 * @param value
			 *            allowed object is {@link RigidBody.TechniqueCommon.Shape.Hollow }
			 * 
			 */
