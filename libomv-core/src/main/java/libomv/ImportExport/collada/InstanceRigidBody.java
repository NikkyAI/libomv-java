...
public class InstanceRigidBody {
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "angularVelocity", "velocity", "dynamic", "mass", "massFrame", "inertia",
			"instancePhysicsMaterial", "physicsMaterial", "shape" })
	public static class TechniqueCommon {
		 ...
		 * Therefore any modification you make to the returned list will be present
		 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
		 * for the angularVelocity property.
		 *
		 * <p>
		 * For example, to add a new item, do as follows:
		 *
		 ...
		 *
		 * @return possible object is {@link InstanceRigidBody.TechniqueCommon.Dynamic }
		 *
		 */
		...
		public static class MassFrame {
			...
			public List<Object> getTranslateOrRotate() {
				if (translateOrRotate == null) {
					translateOrRotate = new ArrayList<>();
				}
