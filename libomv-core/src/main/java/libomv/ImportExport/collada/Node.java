...
@XmlType(name = "", propOrder = { "asset", "lookatOrMatrixOrRotate", "instanceCamera", "instanceController",
		"instanceGeometry", "instanceLight", "instanceNode", "node", "extra" })
...
public class Node {
	 ...
	 * for the lookatOrMatrixOrRotate property.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Matrix }
	 * {@link Skew } {@link Lookat } {@link JAXBElement
	 * }{@code <}{@link TargetableFloat3 }{@code >} {@link Rotate }
	...
	/**
	 * 
	 * The node element may instance any number of camera objects. Gets the value of
	 * the instanceCamera property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the instanceCamera property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * value of the instanceController property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the instanceController property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	...
	/**
	 * 
	 * The node element may instance any number of geometry objects. Gets the value
	 * of the instanceGeometry property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the instanceGeometry property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	...
	/**
	 * 
	 * The node element may instance any number of light objects. Gets the value of
	 * the instanceLight property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the instanceLight property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * objects. Gets the value of the instanceNode property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the instanceNode property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	...
	/**
	 * 
	 * The node element may be hierarchical and be the parent of any number of other
	 * node elements. Gets the value of the node property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
