...
@XmlType(name = "gles_sampler_state", propOrder = { "wrapS", "wrapT", "minfilter", "magfilter", "mipfilter",
		"mipmapMaxlevel", "mipmapBias", "extra" })
public class GlesSamplerState {
	...
	/**
	 * 
	 * The extra element may appear any number of times. OpenGL ES extensions may be
	 * used here. Gets the value of the extra property.
	 * 
	 * <p>
