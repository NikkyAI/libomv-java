...
public class StdDequantizerParams extends DequantizerParams
{
	 ...
	 * resolution level, and the second the subband index (within the resolution
	...
	/**
	 * The quantization step for non-reversible systems, normalized to a dynamic
	 * range of 1, for each resolution level and subband, as derived from the
	 * exponent-mantissa representation in the codestream. The first index is
	 * the resolution level, and the second the subband index (within the
	 ...
	 * 
	 * @return The type of the dequantizer for which the parameters are. Always
	 *         Q_TYPE_SCALAR_DZ.
	 * 
	 * @see Dequantizer
	 */
