...
public class PktInfo
{
	 ...
	 * previous packets, for this code-block. This is the number of passes that
	 * can be decoded with the information in this packet and all previous ones.
	 */
	...
	{
		return "packet " + packetIdx + " (lay:" + layerIdx + ", off:" + cbOff + ", len:" + cbLength + ", numTruncPnts:"
				+ numTruncPnts + ")\n";
	}
}
