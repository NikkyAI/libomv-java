 ...
 * reconstruction resolution level. If that where not the case the implementing
 * class should have additional data structures to store those values for each
...
public abstract class InverseWT extends InvWTAdapter implements BlkImgDataSrc
{
	 ...
	 * (i.e. the maximum resolution available from the 'src' source).
	 * 
	 * <p>
	 ...
	 * with the special additional parameters from the parameter list. Currently
