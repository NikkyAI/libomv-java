 ...
 * position 'n' has the index 'truncIdxs[n]', the rate
...
public class CBlkRateDistStats extends CodedCBlk
{
	...
	/**
	 * Compute the rate-distorsion slopes and selects those that lie in a convex
	 * hull. It will compute the slopes, select the ones that form the convex
	 * hull and initialize the 'truncIdxs' and 'truncSlopes' arrays, as well as
	...
	{
		String str = super.toString() + "\n nVldTrunc=" + nVldTrunc + ", nTotTrunc=" + nTotTrunc + ", num. ROI coeff="
				+ nROIcoeff + ", num. ROI coding passes=" + nROIcp + ", sb=" + sb.sbandIdx;
		// str += "\n\ttruncRates:\n";
