...
/**
 * This abstract class describes the ROI mask for a single subband. Each object
 * of the class contains the mask for a particular subband and also has
 * references to the masks of the children subbands of the subband corresponding
 * to this mask.
 */
