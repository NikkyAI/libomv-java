...
/**
 * This class generates the ROI masks for the ROIScaler.It gives the scaler the
 * ROI mask for the current code-block.
 * 
 * <P>
...
public abstract class ROIMaskGenerator
{
	...
	/**
	 * This functions gets a DataBlk with the size of the current code-block and
	 * fills it with the ROI mask. The lowest scaling value in the mask for this
	 * code-block is returned by the function to be used for modifying the rate
