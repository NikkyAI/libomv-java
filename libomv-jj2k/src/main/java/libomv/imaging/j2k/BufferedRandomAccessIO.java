...
class BufferedRandomAccessIO implements OSRandomAccessIO {
	...
	public BufferedRandomAccessIO() {
		this(1 << 18, Integer.MAX_VALUE);
	}

	public BufferedRandomAccessIO(int size, int maxsize) {
		if (size < 0 || maxsize <= 0) {
	...
	public BufferedRandomAccessIO(byte[] data, int maxsize) {
		if (data == null) {
			throw new IllegalArgumentException();
		}
	 ...
	 *
	 * @param The
	 *            next byte-aligned signed byte (8 bit).
	 *
	 * @exception IOException
	 *                If an I/O error occurred.
	 */
	 ...
	 *
	 * @param The
	 *            next byte-aligned signed short (16 bit).
	 *
	 * @exception IOException
	 *                If an I/O error occurred.
	 */
	 ...
	 *
	 * @param The
	 *            next byte-aligned signed int (32 bit).
	 *
	 * @exception IOException
	 *                If an I/O error occurred.
	 */
	 ...
	 *
	 * @param The
	 *            next byte-aligned signed long (64 bit).
	 *
	 * @exception IOException
	 *                If an I/O error occurred.
	 */
	...
	/**
	 * Flush the output. Does nothing since this class stores all the data
	 * internally.
	 */
	@Override
	public void flush() {
	 ...
	 *
	 * @exception EOFException
	 *                If the end-of currently defined data was reached before
	 *                gettingall the requested data.
	 * @exception IOException
	 *                If an I/O error ocurred.
	 * @exception RuntimeException
	 *                If an error occurred during array copy.
	 */
	@Override
	 ...
	 *            The byte array buffer
	 * @param off
	 *            The offset into the byte array buffer from which to start
	 * @param len
	 *            The number of bytes to copy to the internal buffer
	 *
	 * @exception IOException
	 *                If an I/O error occurred.
	 * @exception RuntimeException
