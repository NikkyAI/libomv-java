...
public class PalettizedColorSpaceMapper extends ColorSpaceMapper
{
	...
	public DataBlk getCompData(DataBlk out, int c)
	{
		...
		if (ncomps != 1)
		{
			String msg = "PalettizedColorSpaceMapper: color palette _not_ applied, incorrect number ("
	...
	public String toString()
	{
		...
		if (pbox != null)
		{
			body.append("ncomps= ").append(getNumComps()).append(", scomp= ").append(srcChannel);
