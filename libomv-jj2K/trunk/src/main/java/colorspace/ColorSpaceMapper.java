...
/**
 * This is the base class for all modules in the colorspace and icc profiling
...
public abstract class ColorSpaceMapper extends ImgDataAdapter implements BlkImgDataSrc
{
	...
	private final static String[][] pinfo = { { "IcolorSpacedebug", null,
	...
	protected static void setInternalBuffer(DataBlk db)
	{
		switch (db.getDataType())
		{
			...
			case DataBlk.TYPE_FLOAT:
				if (db.getData() == null || ((float[]) db.getData()).length < db.w * db.h)
				{
