...
/**
 * This class analyzes the image to provide colorspace information for the
...
public class ColorSpace
{
	...
	{
		StringBuffer rep = new StringBuffer("[ColorSpace is ").append(csbox.getMethodString())
	...
	{
		return pl.getProperty("colorspace_debug") != null && pl.getProperty("colorspace_debug").equalsIgnoreCase("on");
	}
