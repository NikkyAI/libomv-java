...
public final class PaletteBox extends JP2Box
{
	...
	{
		StringBuffer rep = new StringBuffer("[PaletteBox ").append("nentries= ").append(String.valueOf(nentries))
				.append(", ncolumns= ").append(String.valueOf(ncolumns)).append(", bitdepth per column= (");
