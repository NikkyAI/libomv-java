...
/**
 * This interface defines the IDs of the possible quantization types. JPEG 2000
 * part I support only the scalar quantization with dead zone. However other
 * quantization type may be defined in JPEG 2000 extensions (for instance
