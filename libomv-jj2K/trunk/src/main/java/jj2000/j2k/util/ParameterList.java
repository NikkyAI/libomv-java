...
public class ParameterList extends Properties
{
	 ...
	 * 
	 * @exception StringFormatException
	 *                If the parameter has a value which is neither "on" nor
	 *                "off".
	 * 
	 ...
	 * 
	 * @param plist
	 *            The list of valid parameter names for the 'prfx' prefix. If
	 ...
	 * 
	 * @param plist
	 *            The list of valid parameter names. If null it is considered
