...
public class ArrayUtil
{
	...
	/**
	 * Reinitializes an int array to the given value in an optimized way. If the
	 * length of the array is less than MAX_EL_COPYING, then the array is set
	 * element by element in the normal way, otherwise the first INIT_EL_COPYING
	 * elements are set element by element and then System.arraycopy is used to
	 * set the other parts of the array.
	 * 
	 * @param arr
	 *            The array to set.
	 * 
	...
	/**
	 * Reinitializes a byte array to the given value in an optimized way. If the
	 * length of the array is less than MAX_EL_COPYING, then the array is set
	 * element by element in the normal way, otherwise the first INIT_EL_COPYING
	 * elements are set element by element and then System.arraycopy is used to
	 * set the other parts of the array.
