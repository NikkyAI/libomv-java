 ...
 * and/or displays messages or simple strings. The underlying facility can be a
 ...
 * via the 'print()', 'println()' and 'flush()' methods, each simple string is
...
public interface MsgLogger
{
	...
	/**
	 * Severity of message. WARNING messages denote that an unexpected state has
	 * been reached and should be given as feedback to the user.
	 */
	public static final int WARNING = 2;

	/**
	 * Severity of message. ERROR messages denote that something has gone wrong
	 * and probably that execution has ended. They should be definetely
	 ...
	 * severity 'sev'. Some implementations where the appended newline is
	 ...
	 * The message is reformatted as appropriate to the particular diplaying
	 * device, where 'flind' and 'ind' are used as hints for performing that
	 * operation. However, any newlines appearing in 'str' are respected. The
	 * output device may not display the string until flush() is called. Some
	 * implementations may automatically flush when this method is called. This
	 * method just prints the string, the string does not make part of a
	 * "message" in the sense that no severity is associated to it.
	 * 
	 * @param str
	 *            The string to print
	 * 
