 ...
 * layers. This object can contain either all code-block data (i.e. all layers),
...
public class DecLyrdCBlk extends CodedCBlk
{
	 ...
	 * segments is to be deduced from 'ftpIdx', 'nTrunc' and the coding options.
	 * This array contains all terminated segments from the 'ftpIdx' truncation
	 * point, upto, and including, the 'nTrunc-1' truncation point. Any data
	 * after 'nTrunc-1' is not included in any length.
	 */
	...
	public String toString()
	{
		String str = "Coded code-block (" + m + "," + n + "): " + skipMSBP + " MSB skipped, " + dl + " bytes, "
				+ nTrunc + " truncation points, " + nl + " layers, progressive=" + prog + ", ulx=" + ulx
				+ ", uly=" + uly + ", w=" + w + ", h=" + h + ", ftpIdx=" + ftpIdx;
		if (tsLengths != null)
		{
			str += " {";
