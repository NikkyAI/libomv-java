 ...
 * it in a code-block by code-block basis. In each call to 'geCodeBlock()' a
 ...
 * 
 * <p>
 * For each coded-code-block the entropy-coded data is returned along with its
 * truncation point information in a 'DecLyrdCBlk' object.
 * </p>
 * 
 * @see EntropyDecoder
 * 
...
public interface CodedCBlkDataSrcDec extends InvWTData
{
	 ...
	 * number of layers that is returned depends on 'nl' and the amount of data
	 * available.
	 * 
	 * <p>
	 * The argument 'fl' is to be used by subsequent calls to this method for
	 * the same code-block. In this way supplamental data can be retrieved at a
	 ...
	 * all the data that can be obtained for the specified subblock.
	 * </p>
	 * 
	 * <p>
	 ...
	 * code-bock vertical and horizontal indexes 'm' and 'n'.
	 * </p>
	 * 
	 * <p>
