 ...
 * returned as the functional block that performs the forward wavelet transform.
 * 
 * <p>
 * This class assumes that data is transferred in code-blocks, as defined by the
