 ...
 * It implements the forward wavelet transform specifically for the 5x3 filter.
...
public class AnWTFilterIntLift5x3 extends AnWTFilterInt
{
	...
	/**
	 * An implementation of the analyze_lpf() method that works on int data, for
	 * the forward 5x3 wavelet transform using the lifting scheme. See the
	 ...
	 */
	@Override
	public void analyze_lpf(int inSig[], int inOff, int inLen, int inStep, int lowSig[], int lowOff, int lowStep,
	...
	/**
	 * An implementation of the analyze_hpf() method that works on int data, for
	 * the forward 5x3 wavelet transform using the lifting scheme. See the
	 ...
	 */
	@Override
	public void analyze_hpf(int inSig[], int inOff, int inLen, int inStep, int lowSig[], int lowOff, int lowStep,
			int highSig[], int highOff, int highStep)
	{
		int i;
		int iStep = 2 * inStep; // Subsampling in inSig
	 ...
	 * overlap, this method should return false. The term "inner" indicates that
	...
	/**
	 * Tests if the 'obj' object is the same filter as this one. Two filters are
	...
	public boolean equals(Object obj)
	{
		...
		return obj == null ? false : obj == this || obj instanceof AnWTFilterIntLift5x3;
	}
