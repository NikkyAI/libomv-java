...
/**
 * This abstract class defines methods to transfer wavelet data in a code-block
 * by code-block basis. In each call to 'getNextCodeBlock()' or
 * 'getNextInternCodeBlock()' a new code-block is returned. The code-blocks are
...
public interface CBlkWTDataSrc extends ForwWTDataProps
{
	 ...
	 * current tile. Its value should be either DataBlk.TYPE_INT or
