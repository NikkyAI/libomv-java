...
/**
 * This extends the analysis wavelet filter general definitions of AnWTFilter by
 * adding methods that work for float data specifically. Implementations that
...
public abstract class AnWTFilterFloat extends AnWTFilter
{
	 ...
	 * See the general description of the analyze_lpf() method in the AnWTFilter
	 ...
	 * specialized version. See the description of the analyze_lpf() method of
	 ...
	 */
	@Override
	public void analyze_lpf(Object inSig, int inOff, int inLen, int inStep, Object lowSig, int lowOff, int lowStep,
			Object highSig, int highOff, int highStep)
	{

		analyze_lpf((float[]) inSig, inOff, inLen, inStep, (float[]) lowSig, lowOff, lowStep, (float[]) highSig,
				highOff, highStep);
	}

	/**
	 * A specific version of the analyze_hpf() method that works on int data.
	 * See the general description of the analyze_hpf() method in the AnWTFilter
	 * class for more details.
	 * 
	 * @param inSig
	 *            This is the array that contains the input signal.
	 ...
	 * specialized version. See the description of the analyze_hpf() method of
	 * the AnWTFilter class for more details.
	 * 
	 * @param inSig
	 *            This is the array that contains the input signal. It must be
	 ...
	 */
	@Override
	public void analyze_hpf(Object inSig, int inOff, int inLen, int inStep, Object lowSig, int lowOff, int lowStep,
			Object highSig, int highOff, int highStep)
	{

		analyze_hpf((float[]) inSig, inOff, inLen, inStep, (float[]) lowSig, lowOff, lowStep, (float[]) highSig,
				highOff, highStep);
	}

	/**
	 * Returns the type of data on which this filter works, as defined in the
	 * DataBlk interface, which is always TYPE_FLOAT for this class.
	 * 
