...
public class SynWTFilterIntLift5x3 extends SynWTFilterInt
{
	...
	/**
	 * An implementation of the synthetize_lpf() method that works on int data,
	 * for the inverse 5x3 wavelet transform using the lifting scheme. See the
	...
	/**
	 * An implementation of the synthetize_hpf() method that works on int data,
	 * for the inverse 5x3 wavelet transform using thelifting scheme. See the
