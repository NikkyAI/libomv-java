...
/**
 * This extends the synthesis wavelet filter general definitions of SynWTFilter
 * by adding methods that work for int data specifically. Implementations that
 * work on int data should inherit from this class.
 * 
 * <P>
...
public abstract class SynWTFilterInt extends SynWTFilter
{
	 ...
	 * See the general description of the synthetize_lpf() method in the
	 ...
	 *            signal samples in the lowSig array.
	 * 
	 * @param highSig
	 ...
	 *            signal samples in the highSig array.
	 * 
	 * @param outSig
	 *            This is the array where the output signal is placed. It should
	 *            be long enough to contain the output signal.
	 * 
	 * @param outOff
	 ...
	 * specialized version. See the description of the synthetize_lpf() method
	 * of the SynWTFilter class for more details.
	 * 
	 * @param lowSig
	 ...
	 * @param outSig
	 *            This is the array where the output signal is placed. It should
	 *            be and int[] and long enough to contain the output signal.
	 * 
	 * @param outOff
	 *            This is the index in outSig of the element where to put the
	 *            first output sample.
	 ...
	 * See the general description of the synthetize_hpf() method in the
	 * SynWTFilter class for more details.
	 * 
	 * @param lowSig
	 *            This is the array that contains the low-pass input signal.
	 ...
	 * specialized version. See the description of the synthetize_hpf() method
	 * of the SynWTFilter class for more details.
	 * 
	 * @param lowSig
	 *            This is the array that contains the low-pass input signal. It
	 ...
	 * DataBlk interface, which is always TYPE_INT for this class.
	 * 
