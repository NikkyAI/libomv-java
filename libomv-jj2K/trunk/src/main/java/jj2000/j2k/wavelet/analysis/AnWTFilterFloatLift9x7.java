...
public class AnWTFilterFloatLift9x7 extends AnWTFilterFloat
{
	...
	private final static float HPSynthesisFilter[] = { 0.026749f, 0.016864f, -0.078223f, -0.266864f, 0.602949f,
	 ...
	 * the forward 9x7 wavelet transform using the lifting scheme. See the
