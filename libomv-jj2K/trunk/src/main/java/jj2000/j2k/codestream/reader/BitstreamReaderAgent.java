...
public abstract class BitstreamReaderAgent implements CodedCBlkDataSrcDec
{
	 ...
	 * 
	 * @param pl
	 *            The parameter list containing parameters applicable to the bit
	 ...
	 *                If an I/O error occurs while reading initial data from the
	 *                bit stream.
	 * @exception IllegalArgumentException
	 *                If an unrecognised bit stream reader option is present.
	 */
	public static BitstreamReaderAgent createInstance(RandomAccessIO in, HeaderDecoder hd, ParameterList pl,
			DecoderSpecs decSpec, boolean cdstrInfo, HeaderInfo hi) throws IOException
	{
