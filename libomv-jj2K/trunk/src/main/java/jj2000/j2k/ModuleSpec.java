...
public class ModuleSpec implements Cloneable
{
	...
	protected Object clone()
	{
		...
		if (tileCompVal != null)
		{
			...
			String tmpKey;
			Object tmpVal;
			for (Enumeration<String> e = tileCompVal.keys(); e.hasMoreElements();)
			{
	...
	public void rotate90(Coord anT)
	{
		...
		{
			Hashtable<String, Object> tmptcv = new Hashtable<String, Object>();
			String tmpKey;
			Object tmpVal;
			int btIdx, atIdx;
			int i1, i2;
	...
	public void setTileCompVal(int t, int c, Object value)
	{
		...
		if (tileCompVal == null)
			tileCompVal = new Hashtable<String, Object>();
