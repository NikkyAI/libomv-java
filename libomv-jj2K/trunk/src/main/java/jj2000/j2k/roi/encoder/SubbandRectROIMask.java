 ...
 * the masks of the children subbands of the subband corresponding to this mask.
 * This class describes subband masks for images containing only rectangular
 * ROIS
 */
public class SubbandRectROIMask extends SubbandROIMask
{
	 ...
	 * as parameters. A tree of masks is generated from the subband sb. Each
	 * Subband contains the boundaries of each ROI.
	 * 
	 * @param sb
