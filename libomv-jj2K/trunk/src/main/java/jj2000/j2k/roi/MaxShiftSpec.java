...
/**
 * This class contains the maxshift scaling value for each tile-component. The
 * scaling values used are calculated in the ROIScaler class
 */
...
public class MaxShiftSpec extends ModuleSpec
{
	 ...
	 * tiles to the 'SPEC_DEF' spec type, for the specified number of components
	 * and tiles.
	 * 
	 * @param nt
	 *            The number of tiles
