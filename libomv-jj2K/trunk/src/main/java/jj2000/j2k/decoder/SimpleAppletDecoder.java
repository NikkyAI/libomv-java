 ...
 * output files. The image is downloaded, decoded and shown in the applet area.
 * Scrollbars appear if the image is larger than the applet area.
 * 
 * <P>
 * An example use could be:<BR>
 * <BR>
 * <tt>
 * 
...
public class SimpleAppletDecoder extends Applet implements Runnable
{
	...
	public void run()
	{
		...
		if (dec != null)
			return; // already running a decoder!
