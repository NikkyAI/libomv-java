...
/**
 * This class provides ICC Profiling API for the jj2000.j2k imaging chain by
...
public class ICCProfiler extends ColorSpaceMapper
{
	 ...
	 */
	public static BlkImgDataSrc createInstance(BlkImgDataSrc src, ColorSpace csMap) throws IOException,
	 ...
	 */
	protected ICCProfiler(BlkImgDataSrc src, ColorSpace csMap) throws ColorSpaceException, IOException,
	 ...
	 * @exception IllegalArgumentException
	 */
	private RestrictedICCProfile getICCProfile(ColorSpace csm) throws ColorSpaceException, ICCProfileException,
			IllegalArgumentException
	{
		...
		switch (ncomps)
		{
			...
			case 3:
				...
				break;
			default:
				throw new IllegalArgumentException("illegal number of components (" + ncomps + ") in image");
		}
		return ricc;
	}
					...
					case DataBlk.TYPE_FLOAT:
						...
						for (int row = 0; row < outblk.h; ++row)
						{
							...
							for (kOut = leftedgeOut, kIn = leftedgeIn; kIn < rightedgeIn; ++kIn, ++kOut)
							{
								...
								workDataFloat[i][kOut] = ((tmpFloat < 0) ? 0
