...
public class LookUpTable16LinearSRGBtoSRGB extends LookUpTable16
{
	 ...
	 *            post shadow region parameter
	 */
	protected LookUpTable16LinearSRGBtoSRGB(int wShadowCutoff, double dfShadowSlope, int ksRGBLinearMaxValue,
			double ksRGB8ScaleAfterExp, double ksRGBExponent, double ksRGB8ReduceAfterExp)
	{
