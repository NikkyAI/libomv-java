...
abstract class LookUpTable32 extends LookUpTable
{
	 ...
	 */
	public static LookUpTable32 createInstance(ICCCurveType curve, // Pointer to
																	// the curve
																	// data
	 ...
	 *            max output value of the lut
	 */
	protected LookUpTable32(int dwNumInput, // Number of i nput values in
											// created LUT
			int dwMaxOutput // Maximum output value of the LUT
	)
	{
	 ...
	 *            max output value of the lut
	 */
	protected LookUpTable32(ICCCurveType curve, // Pointer to the curve data
			int dwNumInput, // Number of input values in created LUT
			int dwMaxOutput // Maximum output value of the LUT
	)
	{
